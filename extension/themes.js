...
const THEMES = [
  { id: 'classic', icons: 'plump', name: 'Classic Cream', vibe: 'the default, calm',
  ...
  { id: 'academia', icons: 'hand', name: 'Dark Academia', vibe: 'parchment, oxblood, old library',
  ...
  { id: 'blush', icons: 'plump', name: 'Blush', vibe: 'soft pink, bows, matcha lattes',
  ...
  { id: 'haze', icons: 'cyber', name: 'Lavender Haze', vibe: 'lilac, late night, headphones on',
  ...
  { id: 'matcha', icons: 'plump', name: 'Matcha', vibe: 'sage, clay, quiet morning',
  ...
  { id: 'coastal', icons: 'plump', name: 'Coastal', vibe: 'sea glass, linen, open window',
  ...
  { id: 'midnight', icons: 'sharp', name: 'Midnight', vibe: 'navy, electric blue, 2am',
  ...
  { id: 'sunset', icons: 'hand', name: 'Sunset', vibe: 'peach to coral, golden hour',
  ...
  { id: 'blossom', icons: 'thin', name: 'Cherry Blossom', vibe: 'petals, spring, pink on navy at night',
  ...
  { id: 'lofi', icons: 'cyber', name: 'Lo-fi', vibe: 'muted purple, rain on the window',
  ...
  { id: 'cottage', icons: 'plump', name: 'Cottage', vibe: 'cream, moss, terracotta',
  ...
  { id: 'nightshift', icons: 'sharp', name: 'Night Shift', vibe: 'the blue-grey dark, for the late shift',
  ...
  { id: 'seafoam', icons: 'plump', name: 'Sea Foam', vibe: 'pale mint, salt air, clean desk',
  ...
  { id: 'beigestudy', icons: 'plump', name: 'Study Beige', vibe: 'oat paper, brown pen, nothing loud',
  ...
  { id: 'strawberry', icons: 'plump', name: 'Strawberry Matcha', vibe: 'pink and green, iced, summer',
  ...
  { id: 'frutiger', icons: 'pixel', name: 'Frutiger', vibe: 'glossy 2000s cyan, bubbles, a fresh install',
  ...
  { id: 'parks', icons: 'hand', name: 'National Parks', vibe: 'pine, canvas tent, a printed map',
  ...
  { id: 'plumnight', icons: 'cyber', name: 'Plum Night', vibe: 'aubergine dark, one soft star',
...
const MORE_THEMES = [
  { id: 'linen', icons: 'plump', name: 'Linen', vibe: 'unbleached cloth, terracotta, a quiet desk',
  ...
  { id: 'oled', icons: 'sharp', name: 'Pure Black', vibe: 'true black, one mint line, nothing else',
  ...
  { id: 'slate', icons: 'sharp', name: 'Slate', vibe: 'cool grey, steel blue, overcast and calm',
  ...
  { id: 'honey', icons: 'hand', name: 'Honey', vibe: 'oat paper, amber ink, a warm lamp',
  ...
  { id: 'inkwell', icons: 'sharp', name: 'Inkwell', vibe: 'white paper, blue-black ink, a fountain pen',
  ...
  { id: 'peachplum', icons: 'thin', name: 'Peach & Plum', vibe: 'apricot by day, aubergine by night',
...
const IMAGE_THEMES = [
  { id: 'graffiti', icons: 'pixel', name: 'Graffiti', vibe: 'spray paint on brick, pink and cyan, night',
  ...
  { id: 'neoncity', icons: 'cyber', name: 'Anime Night City', vibe: 'rainy Tokyo, neon, lavender dusk',
    paper: { light: 'lavender', dark: 'ink' }, accent: { light: '#6A4FB0', dark: '#B9A6F0' },
  ...
  { id: 'vaporwave', icons: 'pixel', name: 'Vaporwave', vibe: 'sunset grid, palms, magenta to teal',
  ...
  { id: 'nebula', icons: 'cyber', name: 'Nebula', vibe: 'indigo and plum, one gold star, quiet',
    paper: { light: 'lavender', dark: 'ink' }, accent: { light: '#6A4FB0', dark: '#B9A6F0' },
    rail: { light: '#4E3A8C', dark: '#241C40' },
...
/// `icons` names the icon set the look wears on the left bar and in the lists
/// (receipt.js `skinClasses` → `pk-icons-<set>`; skin.css holds the sets):
/// plump (round, friendly), sharp (square, cool), hand (drawn in ink),
/// pixel (8-bit), cyber (thin tech line), thin (fine, elegant).
