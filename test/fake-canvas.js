...
<div class="context_module started has_requirements"><div class="ig-header header"><h2 class="ig-header-title"><span class="name">Unit 4 — Rotation</span></h2><div class="ig-header-admin"><div class="completion_status"><i class="icon-check complete_icon" title="Completed"></i><i class="icon-minimize in_progress_icon" title="Started"></i><i class="icon-lock locked_icon" title="Locked"></i></div></div></div>
...
<div class="context_module locked"><div class="ig-header header"><h2 class="ig-header-title"><span class="name">Unit 5 — Oscillation</span></h2><div class="ig-header-admin"><div class="completion_status"><i class="icon-check complete_icon" title="Completed"></i><i class="icon-minimize in_progress_icon" title="Started"></i><i class="icon-lock locked_icon" title="Locked"></i></div></div></div><ul class="ig-list items context_module_items"><li class="context_module_item indent_0"><div class="ig-row"><div class="ig-info"><span class="item_name"><a class="title" href="#">Read: Hooke's law</a><span class="title locked_title">Read: Hooke's law</span></span></div></div></li></ul></div>
</div></div>`;
